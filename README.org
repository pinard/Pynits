...
Pynits is internally documented in French.  It is internationalised however, and produces English messages by default.  If the *LANG* environment variable is set to =fr=, messages will show in French.
...
| \c | <Plug>Pynits\_column\_fill_layout   |
...
| \f | <Plug>Pynits\_choose_filling\_tool |
...
| \" | <Plug>Pynits\_force\_double_quotes |
| \' | <Plug>Pynits\_force\_single_quotes |
